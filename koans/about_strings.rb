...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # Modify the original string, so everthing is kept up to date.
  end
  ...
  def test_you_can_get_a_substring_from_a_string
    ...
    assert_equal "let", string[7,3] # 3 char's starting at index 7
    assert_equal "let", string[7..9]   # char's 7 through 9, inclusive
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # A little, why would it give back Ascii value?
  end
