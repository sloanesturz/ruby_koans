...
class AboutSymbols < EdgeCase::Koan
  ...
  #
  # declaring the symbol :test_method_names_become_symbols to search in the Symbols list would put
  # that symbol in the list, meaning our search would be useless.
  ...
  #
  # Want to keep list of symbols small, also there's not a ton we can do with them.
end
