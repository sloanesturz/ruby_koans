...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Runs some code over the array, passing a piece of data to every iteration.
    # Returns that piece of data. Initial value of the aux-data is the parameter to inject
  end
